  ...
  <article class="wiki-module wiki-res-page">
    <section class="page-hero page-hero--tome" aria-labelledby="wiki-wpn-heading">
      <div class="container">
        ...
        <div class="ad-wrap" style="width: 100%; height: 100px; display: flex; justify-content: center; align-items: center;">
          <GptBanner gpt-slot-id="div-gpt-ad-wiki-weapons-01" :rotation-index="0" />
        </div>
      </div>
    </section>
    ...
    <section class="wiki-category-section" aria-labelledby="wiki-wpn-table-heading">
      <div class="container">
        <!-- 广告位 -->
        <div class="ad-wrap" style="width: 100%; height: 100px; display: flex; justify-content: center; align-items: center;">
          <GptBanner gpt-slot-id="div-gpt-ad-wiki-weapons-02" :rotation-index="1" />
        </div>
        ...
        <!-- 广告位 -->
        <div class="ad-wrap" style="width: 100%; height: 100px; display: flex; justify-content: center; align-items: center;">
          <GptBanner gpt-slot-id="div-gpt-ad-wiki-weapons-03" :rotation-index="2" />
        </div>
      </div>
    </section>
  </article>
